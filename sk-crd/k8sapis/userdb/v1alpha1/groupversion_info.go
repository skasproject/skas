// Package v1alpha1 contains API Schema definitions for the userdb v1alpha1 API group
// +kubebuilder:object:generate=true
// +groupName=userdb.skasproject.io
/*
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "userdb.skasproject.io", Version: "v1alpha1"}
